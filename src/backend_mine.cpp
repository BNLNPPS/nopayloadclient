...
nlohmann::json getPayloadIOVs(std::string gt_name, long long major_iov, long long minor_iov){
  //    checkGtExists(gt_name);
    ...
    //return  curlwrapper::get(config::api_url + "payloadiovstest/?gtName=" + gt_name + "&majorIOV=" + std::to_string(major_iov) + "&minorIOV=" + std::to_string(minor_iov));
}
